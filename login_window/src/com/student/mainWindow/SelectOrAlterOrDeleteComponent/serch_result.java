...
public class serch_result extends  JPanel{
    ...
    public serch_result() {
        ...
        ImageIcon icon = new ImageIcon("src/Image/3.jpeg");
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.gridx = 3;
        gridBagLayout.setConstraints(jtf_shengao, gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 6;
        gridBagLayout.setConstraints(jb_course,gbc);
        ...
        jb_course.addActionListener(event->new Course(num));
    }
